...
某跨境电商集团智能选品系统。辅助产品开发专员高效选品，选品结果推送企业 ERP 主系统继续完成品质、编辑、知产等流程开品。

### 业务背景
- **集团优势**：海外仓重仓模式（多国仓），核心类目为家居、工业科学、汽配五金
- **未来方向**：同步探索广泛铺货/代发、精品品牌建设
- **团队结构**：
  - 总部开发中心 — 海外仓重仓模式
  - 业务产品开发团队（新组建）— 全模式尝试，目标借助 AI 辅助选品提高效率
- **优先服务**：业务团队（产品设计业务对接 + 内测）
